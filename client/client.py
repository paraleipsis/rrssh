...
from .misc import new_node_conn_handler, init_conn_channel, init_publisher
from .session import ReverseSSHClientSession
...
class ReverseSSHClient:
    ...
    async def __open_connection(self, conn: asyncssh.SSHClientConnection) -> None:
        """Create a TCP Channel and a TCP Session objects.
           ...
           are added to the active_connections dictionary under the UUID key.
        ...
        try:
            ...
            self.active_connections[node_uuid] = {
                'connection': conn,
                'channel': chan,
                'session': session
            }
            ...
            del self.active_connections[node_uuid]
    ...
    def get_connection(
        ...
        connection = self.active_connections[host_uuid]
        return connection
